 ...
 *
 * Google Apps Script bound to the SPEEDX lead spreadsheet. Receives one
 * HTTPS POST per completed submission from the live tool (see
 * lib/sheets-webhook.ts in the app repo) and appends one row to the
 * "Agency Tool Leads" tab. Never overwrites existing rows.
 *
